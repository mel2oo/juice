...
func PayloadUnaryServerInterceptor(logger *zap.Logger, decider ServerPayloadLoggingDecider) grpc.UnaryServerInterceptor {
...
// separate instance of the logger.
func PayloadStreamServerInterceptor(logger *zap.Logger, decider ServerPayloadLoggingDecider) grpc.StreamServerInterceptor {
...
func PayloadUnaryClientInterceptor(logger *zap.Logger, decider ClientPayloadLoggingDecider) grpc.UnaryClientInterceptor {
...
func PayloadStreamClientInterceptor(logger *zap.Logger, decider ClientPayloadLoggingDecider) grpc.StreamClientInterceptor {
